...
This project provides a Java API that could be used to create address books. The API is generalized to allow for it to be the back-end of clients or GUIs that may have rich features or specific data access optimizations to accommodate user needs. The project's website is located here: http://tmnt-raphael.github.io/AddressBook/.
